  ...
  return (
    <main className="bg-white text-gray-900 min-h-screen font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                body: "Automation is most dangerous right before it does something permanent. Build the gate first â€” approval, confirmation, timeout â€” then build the action.",
      ...
      <section className="max-w-5xl mx-auto px-6 pt-12 pb-10">
        ...
        {/* â”€â”€ BENTO GRID â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">

        {/* CARD 01 â€” CashCast (featured, 2/3 wide on xl) */}
          ...
          <div className="p-6 flex flex-col gap-5 flex-1">
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Cash Ops Â· Python + ML</span>
                </div>
              ...
              <div className="flex flex-wrap gap-1.5 justify-end">
                {["Python","FastAPI","Ridge Regression","Isolation Forest","Plotly.js"].map(t => (
            ...
            <div className="border-l-4 border-cyan-500 pl-5">
              <p className="text-white text-lg font-semibold leading-snug">
                &ldquo;US banks keep $4.2 billion in idle vault cash because every branch orders 20% extra &lsquo;just in case&rsquo;. CashCast uses ML to replace the buffer with a forecast.&rdquo;
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <ul className="flex flex-col gap-2">
                {[
                  "Per-branch Ridge regression on 730 days â€” avg MAPE under 12% on holdout",
                  ...
                  "FastAPI + Plotly.js dashboard, SQLite â€” zero infra, clone and run",
                ].map(item => (
              ...
              <div className="flex flex-col gap-3">
                <div className="rounded-lg border border-slate-700 bg-[#0f1117] p-4">
                  <p className="text-[9px] font-mono text-slate-500 mb-3 uppercase tracking-widest">model results â€” 6 branches</p>
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    {[
                      { label: "Avg MAPE", value: "9.1%", color: "#4ade80" },
                      { label: "Tests", value: "14 âœ“", color: "#22d3ee" },
                  ...
                  <div className="bg-slate-900 rounded px-3 py-2 font-mono text-xs">
                    ...
                    <p className="text-emerald-400">âœ“ 14 passed in 4.72s</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex gap-5 pt-2 border-t border-slate-800 mt-auto">
              <a href="/projects/cashcast" className="text-sm font-bold text-cyan-400 hover:text-cyan-300 transition-colors">Full write-up â†’</a>
              <a href="https://github.com/Sankartk/cashcast" className="text-sm font-bold text-slate-500 hover:text-slate-300 transition-colors" target="_blank" rel="noopener noreferrer">GitHub â†’</a>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 flex flex-col gap-4 flex-1">
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Fleet Ops Â· Java</span>
              </div>
            ...
            <ul className="flex flex-col gap-1.5 flex-1">
              {[
                ...
                "Idempotent alerts â€” same event fires once, not on every poll",
                "Live ops dashboard: resolve alerts, KPIs update every 60s",
                "25+ REST endpoints, 16 tests â€” zero failures",
              ].map(item => (
                <li key={item} className="flex items-start gap-2 text-xs text-slate-400">
            ...
            <div className="bg-slate-900 rounded px-3 py-2 font-mono text-xs mt-1">
              ...
              <p className="text-emerald-400">âœ“ Tests: 16, Failures: 0</p>
            </div>
            <div className="flex gap-5 pt-2 border-t border-slate-800 mt-auto">
              <a href="/projects/fleetpulse" className="text-sm font-bold text-orange-400 hover:text-orange-300 transition-colors">Full write-up â†’</a>
              <a href="https://github.com/Sankartk/fleetpulse" className="text-sm font-bold text-slate-500 hover:text-slate-300 transition-colors" target="_blank" rel="noopener noreferrer">GitHub â†’</a>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 flex flex-col gap-4 flex-1">
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Incident Response Â· AWS</span>
              </div>
              <h3 className="text-xl font-extrabold text-white leading-tight">
            ...
            <ul className="flex flex-col gap-1.5 flex-1">
              {[
                "FAISS-indexed runbooks â€” answer with exact file and line number",
                "LLM stays grounded: only quotes what it found, never invents",
                "Step Functions pauses at SNS gate â€” nothing runs until approved",
            ...
            <div className="flex gap-5 pt-2 border-t border-slate-800 mt-auto">
              <a href="/projects/ops-copilot" className="text-sm font-bold text-blue-400 hover:text-blue-300 transition-colors">Full write-up â†’</a>
              <a href="https://github.com/Sankartk/ops-copilot-bedrock" className="text-sm font-bold text-slate-500 hover:text-slate-300 transition-colors" target="_blank" rel="noopener noreferrer">GitHub â†’</a>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 flex flex-col gap-4 flex-1">
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Financial Ops Â· Python</span>
              </div>
              <h3 className="text-xl font-extrabold text-white leading-tight">
            ...
            <ul className="flex flex-col gap-1.5 flex-1">
              {[
                "94.7% match rate â€” 720 transactions, 30-day run",
                "4 ordered passes: exact â†’ amount+date â†’ reference â†’ fuzzy",
            ...
            <div className="flex gap-5 pt-2 border-t border-slate-800 mt-auto">
              <a href="/projects/ledger-reconciler" className="text-sm font-bold text-emerald-400 hover:text-emerald-300 transition-colors">Full write-up â†’</a>
              <a href="https://github.com/Sankartk/ledger-reconciler" className="text-sm font-bold text-slate-500 hover:text-slate-300 transition-colors" target="_blank" rel="noopener noreferrer">GitHub â†’</a>
            </div>
          </div>
        </div>
